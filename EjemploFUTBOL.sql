...
DROP TABLE "HR"."AFICION" cascade constraints;
DROP TABLE "HR"."CANTICOS" cascade constraints;
DROP TABLE "HR"."EQUIPO" cascade constraints;
DROP TABLE "HR"."ESTADIO" cascade constraints;
DROP TABLE "HR"."JUGADORES" cascade constraints;
...
--------------------------------------------------------
  ...
  CREATE TABLE "HR"."AFICION" 
   (	"AFICION_ID" NUMBER, 
	"NOMBRE_DE_GUERRA" VARCHAR2(40 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "HR"."CANTICOS" 
   (	"CANTICOS_ID" NUMBER, 
	"CANTICOS_NAME" VARCHAR2(20 BYTE), 
	"AFICION_ID" NUMBER
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
  ...
  CREATE TABLE "HR"."ESTADIO" 
   (	"ESTADIO_ID" NUMBER, 
	"ESTADIO_NAME" VARCHAR2(30 BYTE), 
	"LOCALIZACION" VARCHAR2(30 BYTE), 
	"AÑO" DATE, 
	"AFORO" NUMBER
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
...
--------------------------------------------------------
  ...
  CREATE TABLE "HR"."JUGADORES" 
   (	"JUGADORES_ID" NUMBER, 
	"JUGADORES_NAME" VARCHAR2(40 BYTE), 
	"DORSAL" NUMBER, 
	"NACIMIENTO" DATE, 
...
SET DEFINE OFF;
Insert into HR.AFICION (AFICION_ID,NOMBRE_DE_GUERRA,FECHA_FUNDACION,EQUIPO_ID) values ('1','ULTRAS SUR',to_date('01/01/80','DD/MM/RR'),'1');
REM INSERTING into HR.CANTICOS
SET DEFINE OFF;
Insert into HR.CANTICOS (CANTICOS_ID,CANTICOS_NAME,AFICION_ID) values ('1','PEPE EL TERRORISTA','1');
Insert into HR.CANTICOS (CANTICOS_ID,CANTICOS_NAME,AFICION_ID) values ('2','CR7 HAZME UN BOMBO','1');
REM INSERTING into HR.EQUIPO
SET DEFINE OFF;
Insert into HR.EQUIPO (EQUIPO_ID,NOMBRE,FECHA_FUNDACION,ESTADIO_ID) values ('1','REAL MADRID',to_date('03/03/02','DD/MM/RR'),null);
REM INSERTING into HR.ESTADIO
SET DEFINE OFF;
Insert into HR.ESTADIO (ESTADIO_ID,ESTADIO_NAME,LOCALIZACION,"AÑO",AFORO) values ('1','SANTIAGO BERNABEU','MADRID',to_date('14/12/47','DD/MM/RR'),'81044');
REM INSERTING into HR.JUGADORES
SET DEFINE OFF;
Insert into HR.JUGADORES (JUGADORES_ID,JUGADORES_NAME,DORSAL,NACIMIENTO,POSICION,EQUIPO_ID,SUELDO) values ('1','GARETH BALE','11',to_date('16/07/89','DD/MM/RR'),'DELANTERO','1','15000000');
Insert into HR.JUGADORES (JUGADORES_ID,JUGADORES_NAME,DORSAL,NACIMIENTO,POSICION,EQUIPO_ID,SUELDO) values ('2','KARIM BENZEMA','9',to_date('19/12/87','DD/MM/RR'),'DELANTERO','1','7092000');
Insert into HR.JUGADORES (JUGADORES_ID,JUGADORES_NAME,DORSAL,NACIMIENTO,POSICION,EQUIPO_ID,SUELDO) values ('3','PEPE','3',to_date('26/02/83','DD/MM/RR'),'DEFENSA','1','5072000');
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."JUGADORES" ADD CONSTRAINT "EQUIPO_FK1" FOREIGN KEY ("EQUIPO_ID")
	  REFERENCES "HR"."EQUIPO" ("EQUIPO_ID") ENABLE;
--------------------------------------------------------
